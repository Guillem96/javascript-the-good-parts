// Compose an object using diferent parts

// Add an event processor functionallity to an object
var eventuality = function (that) {
    var registry = {};

    that.fire = function (event) {
        // Fires an event on an object. The event can be either a string containing the name
        // of the event or an object containing a type property containing the name of the event
        ...
        // If an array of handlers exists for this event, then loop through it and execute the handlers
        // in order.
